...
-\Delta \Delta \text{Ct} & = -(\Delta \text{Ct}_{t} - \Delta \text{Ct}_{t=0})\\
\Delta \text{Ct}_{t} & = \phi_{\text{target}} \big( \text{Ct}_{\text{target},t} - \text{Ct}_{\text{reference},t} \big)\\
\Delta \text{Ct}_{t=0} & = \phi_{\text{reference}} \big( \text{Ct}_{\text{target},t=0} - \text{Ct}_{\text{reference},t=0} \big)\\
\tag{4}
\end{align}
$$ 
...
And the code below shows a full example of adding adjusted time-based $\Delta \Delta \text{Ct}$ to a data frame and visualizing the result.
