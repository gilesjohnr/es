...
See below for an example of how to use the `es` package to download geographic boundaries and identify the administrative units for a set of sampling sites.
