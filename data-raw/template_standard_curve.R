...
x <- x[x$target_name %in% unique(x$target_name)[1:4],]
x$target_name[x$target_name == unique(x$target_name)[1]] <- "target_0"
x$target_name[x$target_name == unique(x$target_name)[2]] <- "target_1"
x$target_name[x$target_name == unique(x$target_name)[3]] <- "target_2"
x$target_name[x$target_name == unique(x$target_name)[4]] <- "target_3"
